...
SOURCE_PATH = Path("/Users/karthi/Downloads/section 2 attendence.xlsx")
...
def import_section2_xlsx(
    ...
    try:
        ...
        for row_number in range(7, worksheet.max_row + 1):
            ...
            overall_attendance = worksheet.cell(row=row_number, column=29).value
            ...
            if student is None:
                student = Student(
                    ...
                    section=(csv_row.get("sectioncode") or "2").strip() or "2",
                ...
                student.section = (csv_row.get("sectioncode") or student.section or "2").strip() or "2"
            ...
            for column, subject_label in subjects:
                attendance_percentage = _attendance_value(worksheet.cell(row=row_number, column=column).value)
...
if __name__ == "__main__":
    ...
    import_section2_xlsx(cli_source_path)
